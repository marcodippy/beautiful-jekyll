...
There's a trick we can use to avoid passing everytime the monoid instance to the sum function, this trick is called `implicit parameter` (maybe mention typeclasses here?):
...
- [Monoids: Theme and Variations](http://repository.upenn.edu/cgi/viewcontent.cgi?article=1773&context=cis_papers) (uses Haskell)
