...
Let's write a function to compose two monoids (in this example we're using a `Tuple` for the _composed monoid_, but it could have been also a new class containing both the monoid):
