...
foldMap(events)(eventToStatsByEventType)
/*
	Map(
...
foldMap(events)(eventToStatsByDate)
/*
	Map(
...
```scala
def eventToStatsByEventTypeAndDate(e: Event) = Map(e.date -> eventToStatsByEventType(e))

foldMap(events)(eventToStatsByEventTypeAndDate)
/*
	Map(
