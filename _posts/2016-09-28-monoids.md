...
* Identity Element: the operation must have an element (also called _zero_) that "does nothing": zero _op_ a == a and a _op_ zero == a (these are called, respectively, _left identity_ and _right identity_
